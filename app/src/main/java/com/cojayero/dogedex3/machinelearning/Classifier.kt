...
import com.cojayero.dogedex3.MAX_RECOGNITION_DOG_RESULTS
...
class Classifier(tfLiteModel: MappedByteBuffer, private val labels: List<String>) {
    ...
    private val imageSizeX: Int  //Image size along the x axis.
    private val imageSizeY: Int //Image size along the y axis.
    private var tfLite: Interpreter // An instance of the driver class to run model inference with Tensorflow Lite.
    private var inputImageBuffer: TensorImage // Input image TensorBuffer.
    private val outputProbabilityBuffer: TensorBuffer //Output probability TensorBuffer.
    private val tensorProcessor: TensorProcessor //Processor to apply post processing of the output probability.
